...
# are skipped during VLM enrichment.
# 0.001 = 0.1% of page → captures game icons (~24x24pt) while skipping
# tiny decorative elements (~8x8pt).
VLM_PICTURE_AREA_THRESHOLD: float = 0.001
